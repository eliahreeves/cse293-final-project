...
HD_PWD='/home/ericbreh/Documents/school/cse293-final-project/block-diagram-example/block-diagram-example.runs/design_1_axis_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_gpio_0_0.tcl
